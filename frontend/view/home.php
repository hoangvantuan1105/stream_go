			...
			<div class="row">
				<div class="col-12">
					<div class="catalog__nav">
						...
						<div class="sliding-piece" style="position: absolute; transition: width 0.2s, height 0.2s, top 0.2s, left 0.2s; opacity: 0; left: 5px; top: 5px; width: 79.2812px; height: 30px;"></div></div>
					</div>

					<div class="row row--grid">
						

                        <?php foreach($allInfoMovie as $m) : ?>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="card">
								...
								<h3 class="card__title"><a href="index.php?page=streamVideo"><?= $m['title'] ?></a></h3>
								<ul class="card__list">
									<li><?= $m['type_movie'] ?></li>
									<li>Drama</li>
									<li><?= $m['release_year'] ?></li>
								</ul>
							</div>
						</div>
                        <?php endforeach ?>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="section__carousel-wrap">
						...
						<div class="owl-stage-outer owl-height" style="height: 363.016px;"><div class="owl-stage" style="transform: translate3d(-1330px, 0px, 0px); transition: all; width: 5321px;"><div class="owl-item cloned" style="width: 191.667px; margin-right: 30px;"><div class="card">
							...
							</div></div><div class="owl-item cloned" style="width: 191.667px; margin-right: 30px;"><div class="card">
								<a href="https://flixtv.volkovdesign.com/main/details.html" class="card__cover">
							...
							</div></div><div class="owl-item active" style="width: 191.667px; margin-right: 30px;"><div class="card">
								<a href="https://flixtv.volkovdesign.com/main/details.html" class="card__cover">
							...
							</div></div><div class="owl-item" style="width: 191.667px; margin-right: 30px;"><div class="card">
								<a href="https://flixtv.volkovdesign.com/main/details.html" class="card__cover">
									<img src="/frontend//assets//images//17.png" alt="">
									<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.1615 8.05308C13.1615 9.79908 11.7455 11.2141 9.9995 11.2141C8.2535 11.2141 6.8385 9.79908 6.8385 8.05308C6.8385 6.30608 8.2535 4.89108 9.9995 4.89108C11.7455 4.89108 13.1615 6.30608 13.1615 8.05308Z" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M9.998 15.3549C13.806 15.3549 17.289 12.6169 19.25 8.05289C17.289 3.48888 13.806 0.750885 9.998 0.750885H10.002C6.194 0.750885 2.711 3.48888 0.75 8.05289C2.711 12.6169 6.194 15.3549 10.002 15.3549H9.998Z" stroke-linecap="round" stroke-linejoin="round"></path></svg>
								</a>
