...
<body>
	...
	<div class="home home--static">
		<div class="home__carousel owl-carousel owl-loaded" id="flixtv-hero">
			<div class="owl-stage-outer owl-height" style="height: 329.453px;">
				<div class="owl-stage" style="transition: 1.8s; width: 7094px; transform: translate3d(-1914px, 0px, 0px);">
				...
				<div class="col-12">
					<div class="catalog__nav">
						...
						<div class="slider-radio">
							...
							<div class="sliding-piece" style="position: absolute; transition: width 0.2s, height 0.2s, top 0.2s, left 0.2s; opacity: 0; left: 5px; top: 5px; width: 79.2812px; height: 30px;"></div>
						</div>
					</div>
					...
					<div class="row row--grid">
						...
						<?php foreach ($allInfoMovie as $m) : ?>
							...
							<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
								<div class="card">
									<a href="index.php?page=streamVideo" class="card__cover">
					...
					<div class="plan">
						...
						<ul class="plan__list">
							<li class="green"><svg width="19" height="14" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M1.43994 6.95981L6.77477 12.2924L17.4399 1.62723" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
