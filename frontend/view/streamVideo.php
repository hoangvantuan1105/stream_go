				...
				<div class="row">
						...
						<div class="series-wrap">
							...
							<div class="section__carousel-wrap">
								<div class="section__series owl-carousel owl-loaded" id="series">
									<div class="owl-stage-outer owl-height" style="height: 226.016px;">
										<div class="owl-stage" style="transform: translate3d(-1320px, 0px, 0px); transition: all; width: 4224px;">
											<div class="owl-item cloned" style="width: 244px; margin-right: 20px;">
												<div class="series">
											...
											<div class="owl-item active" style="width: 244px; margin-right: 20px;">
												<div class="series">
													<a href="" class="series__cover">
														<img src="frontend/assets/images/xuanca.jpg" alt="">
														<span>
											...
											<div class="owl-item" style="width: 244px; margin-right: 20px;">
												<div class="series">
													<a href="" class="series__cover">
														<img src="frontend/assets/images/xuanca.jpg" alt="">
														<span>
					...
					<div class="col-12 col-xl-8">
						...
						<div class="categories">
							...
							<a href="" class="categories__item">Action</a>
							<a href="" class="categories__item">Thriller</a>
							<a href="" class="categories__item">Crime</a>
						</div>
						<!-- end categories -->
