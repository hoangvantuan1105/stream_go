			...
			<div class="row">
				<div class="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 order-4 order-md-1 order-lg-4 order-xl-1">
					<div class="footer__flixtv">
						<img src="./main_files/logo.svg" alt="">
					</div>
					<p class="footer__tagline">Movies &amp; TV Shows, Online cinema,<br> Movie database HTML Template.</p>
					<div class="footer__social">
						<a href="https://flixtv.volkovdesign.com/main/index.html#" target="_blank"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path d="M16.5634 23.8197V15.6589H18.8161L19.1147 12.8466H16.5634L16.5672 11.4391C16.5672 10.7056 16.6369 10.3126 17.6904 10.3126H19.0987V7.5H16.8457C14.1394 7.5 13.1869 8.86425 13.1869 11.1585V12.8469H11.4999V15.6592H13.1869V23.8197H16.5634Z" fill="white"></path>
							</svg></a>
						<a href="https://flixtv.volkovdesign.com/main/index.html#" target="_blank"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<a href="https://flixtv.volkovdesign.com/main/index.html#" target="_blank"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path d="M13.2143 13.1245V12.4195C12.9696 12.3808 12.7224 12.3595 12.4747 12.356C10.0763 12.3509 7.95291 13.9051 7.23271 16.1928C6.51252 18.4805 7.36263 20.9708 9.33138 22.3405C7.85664 20.7622 7.44716 18.4646 8.28583 16.474C9.1245 14.4834 11.0547 13.1716 13.2143 13.1245Z" fill="#25F4EE"></path>
								<path d="M13.3472 21.1097C14.6881 21.1079 15.7904 20.0515 15.8491 18.7118V6.75693H18.0332C17.9886 6.50713 17.9673 6.25373 17.9696 6H14.9824V17.9433C14.9327 19.2898 13.8279 20.3564 12.4804 20.3586C12.0778 20.3552 11.6817 20.2561 11.3248 20.0697C11.794 20.7197 12.5456 21.1062 13.3472 21.1097Z" fill="#25F4EE"></path>
				...
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0 offset-xl-1">
					...
					<div class="footer__nav">
						<a href="https://flixtv.volkovdesign.com/main/about.html">About us</a>
						<a href="https://flixtv.volkovdesign.com/main/profile.html">My profile</a>
						<a href="https://flixtv.volkovdesign.com/main/pricing.html">Pricing plans</a>
						<a href="https://flixtv.volkovdesign.com/main/contacts.html">Contacts</a>
					</div>
				</div>
				...
				<div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
					<div class="row">
						...
						<div class="col-6">
							<div class="footer__nav">
								<a href="https://flixtv.volkovdesign.com/main/live.html">Live TV</a>
								<a href="https://flixtv.volkovdesign.com/main/live.html">Live News</a>
								<a href="https://flixtv.volkovdesign.com/main/live.html">Live Sports</a>
								<a href="https://flixtv.volkovdesign.com/main/live.html">Streaming Library</a>
							</div>
						</div>

						<div class="col-6">
							<div class="footer__nav">
								<a href="https://flixtv.volkovdesign.com/main/category.html">TV Shows</a>
								<a href="https://flixtv.volkovdesign.com/main/category.html">Movies</a>
								<a href="https://flixtv.volkovdesign.com/main/category.html">Kids</a>
								<a href="https://flixtv.volkovdesign.com/main/category.html">Collections</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
					...
					<div class="footer__nav">
						<a href="https://flixtv.volkovdesign.com/main/privacy.html">Account &amp; Billing</a>
						<a href="https://flixtv.volkovdesign.com/main/privacy.html">Plans &amp; Pricing</a>
						<a href="https://flixtv.volkovdesign.com/main/privacy.html">Supported devices</a>
						<a href="https://flixtv.volkovdesign.com/main/privacy.html">Accessibility</a>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="footer__content">
						<div class="footer__links">
							<a href="https://flixtv.volkovdesign.com/main/privacy.html">Privacy policy</a>
							<a href="https://flixtv.volkovdesign.com/main/privacy.html">Terms and conditions</a>
						</div>
