...
<div class="container-fluid">
			<div class="row">
						...
						<div class="main__title-wrap">
							...
							<div class="filter" id="filter__sort">
								...
								<ul class="filter__item-menu dropdown-menu scrollbar-dropdown" aria-labelledby="filter-sort">
									<li data-value="date created">Date created</li>
				...
				<div class="col-12">
						...
						<table class="main__table">
							...
							<tbody>
								<tr>
									...
									<td>
										<div class="main__table-text"><?= htmlspecialchars($user['name']) ?></div>
									</td>
									<td>
									...
									<td>
										<div class="main__table-btns">
											...
											<a href="admin.php?page=xoausers&iduser=<?= $user['id'] ?>" class="main__table-btn main__table-btn--delete open-modal">
					...
					</div><div class="scrollbar-track scrollbar-track-x show" style="display: block;"><div class="scrollbar-thumb scrollbar-thumb-x" style="width: 803.932px; transform: translate3d(0px, 0px, 0px);"></div></div><div class="scrollbar-track scrollbar-track-y show" style="display: none;"><div class="scrollbar-thumb scrollbar-thumb-y" style="height: 844px; transform: translate3d(0px, 0px, 0px);"></div></div></div>
				</div>
				<!-- end users -->
